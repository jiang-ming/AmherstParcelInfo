...
namespace AmherstParcelInfo
{
    ...
    ///</summary>
    [Guid("cc2fe3c0-54a5-43f7-8bc8-8aa91b4331ca")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("MapControlApplication.ContextMenu1")]
    public class ContextMenu1
    {
        ...
        public void SetHook(object hook)
        {
            ...
            //
            AddItem("esriControls.ControlsMapRefreshViewCommand", -1);
            ...
            AddItem("esriControls.ControlsMapZoomToLastExtentForwardCommand", -1);
            AddItem("esriControls.ControlsMapZoomToLastExtentBackCommand", -1);
        }
